...
checker = LDBlockChecker(snpfile="/mnt/storage/prs/ldblocks/AD/AD_sign_snps_5e-8.bed")

checker.build_ldblocks()
checker.build_genes()
checker.build_snps()
checker.build_coregenes("/mnt/storage/speos/results/alz_film_nohetioouter_results.json", cs=1)

mendelians = preprocess_labels("/home/ubuntu/speos/extensions/alz_only_genes.tsv")
...
table.to_csv("AD_only_ldblocks_by_snps.tsv", sep="\t")
print(array)
